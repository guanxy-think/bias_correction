...
###But the likelihood of observed trips are incorporated in the integration for n_a. 
...
for (a_file in file_names) {
  ...
  likelihood_function <- function(par) {
    ...
    # log_likelihood_obs <- sum(LL_1) + sum(LL_12) + sum(LL_2)
    ...
    cat(par,file = "C:/Users/guanxy/Documents/logfile_server_15.txt", append=T,fill=T)
    #cat(zone_trips,file = "C:/Users/guanxy/Documents/logfile_server_15.txt", append=T,fill=T)
    cat(lambda_a,file = "C:/Users/guanxy/Documents/logfile_server_15.txt", append=T,fill=T)
    cat(inf_count,file = "C:/Users/guanxy/Documents/logfile_server_15.txt", append=T,fill=T)
    #cat(inf_count_trips,file = "C:/Users/guanxy/Documents/logfile_server_15.txt", append=T,fill=T)
    ...
    for (i in 1:10) {
      likelihoods <- foreach(j = obs_zones_counts[i]:poisson_upper_bound[i], .combine="c", .export=c("obs_zones_counts","obs_1_zones_count","obs_2_zones_count","obs_12_zones_count")) %dopar% {
        ...
        log_likelihood_zones <- likelihood_0 + LL_1_for_each_zone[i] + LL_12_for_each_zone[i] + LL_2_for_each_zone[i]
    ...
    cat(log_likelihood_output,file = "C:/Users/guanxy/Documents/logfile_server_15.txt", append=T,fill=T)
