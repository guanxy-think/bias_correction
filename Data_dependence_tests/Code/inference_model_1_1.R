###same as inference_model_1.R in "zone_homogenity" but change to sum of poisson distribution instead of random sampling
library(foreach)
library(doParallel)
no_cores <- 16
...
for (a_file in file_names) {
  ...
  likelihood_function <- function(par) {
    ...
    cat(par,file = "C:/Users/xiang/Documents/logfile_server.txt", append=T,fill=T)
    all_likelihoods <- c()
    for (i in 1:5) {
    ...
    cat(log_likelihood,file = "C:/Users/xiang/Documents/logfile_server.txt", append=T,fill=T)
