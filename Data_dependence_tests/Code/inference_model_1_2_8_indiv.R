...
for (a_file in file_names) {
  ...
  likelihood_function <- function(par) {
    ...
    cat(par,file = "C:/Users/guanxy/Documents/logfile_server_14.txt", append=T,fill=T)
    #cat(zone_trips,file = "C:/Users/guanxy/Documents/logfile_server_14.txt", append=T,fill=T)
    cat(lambda_a,file = "C:/Users/guanxy/Documents/logfile_server_14.txt", append=T,fill=T)
    cat(inf_count,file = "C:/Users/guanxy/Documents/logfile_server_14.txt", append=T,fill=T)
    cat(inf_count_trips,file = "C:/Users/guanxy/Documents/logfile_server_14.txt", append=T,fill=T)
