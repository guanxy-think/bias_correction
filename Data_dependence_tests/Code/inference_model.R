...
file_names <- c("scen2_0.1_beta_right","scen2_0.5_beta_right","scen2_0.9_beta_right")
...
for (a_file in file_names) {
  ...
  estim <- spg(c(rep(-2,5),rep(-2,5),1000),likelihood_function,lower=c(rep(-Inf,10),0),
  ...
  write.csv(results,paste("G:/My Drive/trip bias paper/scenarios/zone_homogenity/",a_file,".csv",sep=""),row.names=F)
}
