...
##Beta(1,6) for p(i,a,1)
set.seed(1)
p_a_s_12 <- rbeta(total_num_trips,1,9)
p_a_s_1 <- rbeta(total_num_trips,1,2)
p_a_s_2 <- sapply(p_a_s_12/p_a_s_1, function(x) min(1,x))
rand_1 <- runif(total_num_trips)
rand_2 <- runif(total_num_trips)
...
dataset_7 <- data.frame(ppl_set,trip_set,capture_1,capture_2,p_a_s_1,p_a_s_2,popu_density)
...
dataset_8 <- data.frame(ppl_set,trip_set,capture_1,capture_2,p_a_s_1,p_a_s_2,popu_density)
...
dataset_9 <- data.frame(ppl_set,trip_set,capture_1,capture_2,p_a_s_1,p_a_s_2,popu_density)
...
##Beta(1,6) for p(i,a,1)
set.seed(1)
p_a_s_12 <- rbeta(total_num_trips,2,2)
p_a_s_1 <- rbeta(total_num_trips,1,2)
p_a_s_2 <- sapply(p_a_s_12/p_a_s_1, function(x) min(1,x))
rand_1 <- runif(total_num_trips)
rand_2 <- runif(total_num_trips)
...
dataset_10 <- data.frame(ppl_set,trip_set,capture_1,capture_2,p_a_s_1,p_a_s_2,popu_density)
...
dataset_11 <- data.frame(ppl_set,trip_set,capture_1,capture_2,p_a_s_1,p_a_s_2,popu_density)
...
dataset_12 <- data.frame(ppl_set,trip_set,capture_1,capture_2,p_a_s_1,p_a_s_2,popu_density)
...
##Beta(1,6) for p(i,a,1)
set.seed(1)
p_a_s_12 <- rbeta(total_num_trips,9,1)
p_a_s_1 <- rbeta(total_num_trips,1,2)
p_a_s_2 <- sapply(p_a_s_12/p_a_s_1, function(x) min(1,x))
rand_1 <- runif(total_num_trips)
rand_2 <- runif(total_num_trips)
...
dataset_13 <- data.frame(ppl_set,trip_set,capture_1,capture_2,p_a_s_1,p_a_s_2,popu_density)
...
dataset_14 <- data.frame(ppl_set,trip_set,capture_1,capture_2,p_a_s_1,p_a_s_2,popu_density)
...
dataset_15 <- data.frame(ppl_set,trip_set,capture_1,capture_2,p_a_s_1,p_a_s_2,popu_density)
