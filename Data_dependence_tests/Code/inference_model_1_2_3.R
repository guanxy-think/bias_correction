###similar as inference_model_1_2_2.R in "zone_homogenity"
...
for (a_file in file_names) {
  ...
  likelihood_function <- function(par) {
    ...
    poisson_upper_bound <- rep(5000,5)#qpois(0.999999,lambda_a)
  ...
  estim_potim <- optim(c(-2.838559e+00,  3.789795e-07, -5.266927e-03,  3.849894e-07),likelihood_function, method="L-BFGS-B", lower = c(rep(-Inf,4)), upper = c(rep(Inf,4)), #hessian=T,
                       control = list(maxit = 30000,trace = TRUE,ndeps=c(rep(0.000000001,4)),factr=1e5,REPORT=1))
