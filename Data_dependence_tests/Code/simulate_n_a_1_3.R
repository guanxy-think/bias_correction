...
for (a_file in file_names) {
  result_path <- paste("G:/My Drive/trip bias paper/scenarios/representativeness/inference_results/",a_file,"_binom.csv",sep="")
  para_info <- read.csv(result_path)
  para_info$se_data[which(is.na(para_info$se_data))] <- 0
  
  data_path <- paste('G:/My Drive/trip bias paper/scenarios/representativeness/',a_file,".csv",sep="")
