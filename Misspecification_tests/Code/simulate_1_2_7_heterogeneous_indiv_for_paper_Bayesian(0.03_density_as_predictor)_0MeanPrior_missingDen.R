...
result <- read.csv("G:/My Drive/trip bias paper/scenarios/scenario_2_and_3/predictor_correlation/scenario2(-0.03)_density_negNumDensityCor_results_MAP_0MeanPrior_missingDen.csv")
...
for (a_file in file_names) {
  ...
  write.csv(output, "G:/My Drive/trip bias paper/scenarios/scenario_2_and_3/predictor_correlation/LLs/percentages_0.03_den_missing.csv",row.names=F)
