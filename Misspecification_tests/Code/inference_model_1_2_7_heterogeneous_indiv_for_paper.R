...
for (a_file in file_names) {
  ...
  data_baseline <- read.csv(paste('G:/My Drive/trip bias paper/scenarios/scenario_2_and_3/', a_file, sep=""))
  ...
  likelihood_function <- function(par) {
    ...
    cat(par,file = "C:/Users/guanxy/Documents/logfile_paper.txt", append=T,fill=T)
    cat(lambda_a,file = "C:/Users/guanxy/Documents/logfile_paper.txt", append=T,fill=T)
    ...
    cat(log_likelihood_output,file = "C:/Users/guanxy/Documents/logfile_paper.txt", append=T,fill=T)
