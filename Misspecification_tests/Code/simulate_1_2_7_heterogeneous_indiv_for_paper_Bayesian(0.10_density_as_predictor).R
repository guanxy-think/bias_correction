...
result <- read.csv("G:/My Drive/trip bias paper/scenarios/scenario_2_and_3/predictor_correlation/scenario2(-0.10)_density_negNumDensityCor_results_MAP_0MeanPrior_noConst.csv")
...
for (a_file in file_names) {
  ...
  write.csv(LLs, "G:/My Drive/trip bias paper/scenarios/scenario_2_and_3/predictor_correlation/LLs/0.10_density.csv")
  ...
  write.csv(output, "G:/My Drive/trip bias paper/scenarios/scenario_2_and_3/predictor_correlation/LLs/percentages_0.10_density.csv",row.names=F)
