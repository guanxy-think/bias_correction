...
for (a_file in file_names) {
  ...
  likelihood_function <- function(par) {
    ...
    cat(par,file = "C:/Users/guanxy/Documents/logfile_paper_0.10_noPredictor_lambda10_MAP.txt", append=T,fill=T)
    cat(lambda_a,file = "C:/Users/guanxy/Documents/logfile_paper_0.10_noPredictor_lambda10_MAP.txt", append=T,fill=T)
    ...
    cat(log_likelihood_output,file = "C:/Users/guanxy/Documents/logfile_paper_0.10_noPredictor_lambda10_MAP.txt", append=T,fill=T)
  ...
  write.csv(results,"G:/My Drive/trip bias paper/scenarios/scenario_2_and_3/predictor_correlation/regularization/scenario2(-0.10)_noPredictor_MAP.csv",row.names=F)
}
