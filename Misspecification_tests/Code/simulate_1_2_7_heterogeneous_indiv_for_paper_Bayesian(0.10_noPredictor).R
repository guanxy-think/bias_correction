...
# result <- read.csv("G:/My Drive/trip bias paper/scenarios/scenario_2_and_3/predictor_correlation/scenario2(-0.10)_noPredictor_results.csv")

result <- read.csv("G:/My Drive/trip bias paper/scenarios/scenario_2_and_3/predictor_correlation/scenario2(-0.10)_noPredictor_results_MAP_0MeanPrior_noConst.csv")
...
for (a_file in file_names) {
  ...
  write.csv(LLs, "G:/My Drive/trip bias paper/scenarios/scenario_2_and_3/predictor_correlation/LLs/0.10_noPredictor.csv")
  ...
  write.csv(output, "G:/My Drive/trip bias paper/scenarios/scenario_2_and_3/predictor_correlation/LLs/percentages_0.10_noPredictor.csv",row.names=F)
