...
write.csv(dataset_init_new,"G:/My Drive/trip bias paper/scenarios/representativeness/more_zones/SR_SU_regen_with_income_indiv.csv",row.names=F)
write.csv(dataset_zone_incomes,"G:/My Drive/trip bias paper/scenarios/representativeness/more_zones/zone_incomes_regen_with_income_indiv.csv",row.names=F)
