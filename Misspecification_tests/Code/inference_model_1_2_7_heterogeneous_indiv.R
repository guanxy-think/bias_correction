...
for (a_file in file_names) {
  ...
  likelihood_function <- function(par) {
    ...
    cat(par,file = "C:/Users/guanxy/Documents/logfile_server_9.txt", append=T,fill=T)
    cat(lambda_a,file = "C:/Users/guanxy/Documents/logfile_server_9.txt", append=T,fill=T)
    ...
    cat(log_likelihood_output,file = "C:/Users/guanxy/Documents/logfile_server_9.txt", append=T,fill=T)
