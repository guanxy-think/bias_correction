...
file_names <- c("scenario2(-0.10).csv")
                #"SR_LU","SU_LU","LU09_LU"
...
for (a_file in file_names) {
  ...
  for (m in 2:2000) {
    ...
    write.csv(gibbs_samples,"G:/My Drive/trip bias paper/scenarios/scenario_2_and_3/predictor_correlation/scenario2(-0.10)_density_results_MAP.csv",row.names = F)
  }
  ...
  write.csv(results,"G:/My Drive/trip bias paper/scenarios/scenario_2_and_3/predictor_correlation/regularization/scenario2(-0.10)_density_MAP.csv",row.names=F)
}
